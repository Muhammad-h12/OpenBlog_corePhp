...
$sql = "SELECT a.id, a.title, a.content, a.summary, a.created, a.published, a.category_id, a.member_id, 
...
>
                <?php echo html_escape($article['author']);?>
</a>
                    </p>
                  </div>
              ...
              <div class="w-full px-4 lg:w-8/12">
                <div>
                  ...
                  <p
                    ...
                    data-wow-delay=".1s"
                        >
                        <?php echo html_escape( $article['content'] ); ?>
                  </p>
                  <p
...
Share This Post
              ...
              <div class="w-full px-4 lg:w-4/12">
                <div>
                  ...
                  <?php include 'includes/partials/popular-articles.php' ?>

                  <?php include 'includes/partials/newsletter-form.php' ?>
          ...
          <?php include 'includes/partials/related-articles.php' ?>
      </div>
    </section>
